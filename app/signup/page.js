...
export default function SignUpPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert(`${t("auth.signUp.registrationFailed")}: An unexpected error occurred. Please try again.`)
    } finally {
      setIsLoading(false)
    }
  }
      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          <div className="flex justify-center mb-6">
            <Image src="/images/ai-logo.jpg" alt="AI Logo" width={80} height={80} className="rounded-2xl shadow-lg" />
          </div>
          <h2 className="text-3xl font-bold text-slate-700 mb-2">📝 {t("auth.signUp.title")}</h2>
        ...
        <Card className="shadow-xl">
          <CardHeader>
            <CardTitle className="text-center text-slate-700">{t("auth.signUp.getStarted")}</CardTitle>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className={`${isRTL ? "pr-10" : "pl-10"} rounded-xl border-2 focus:border-cyan-500 ${
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    onChange={handleInputChange}
                    className={`${isRTL ? "pr-12 pl-10" : "pl-10 pr-12"} rounded-xl border-2 focus:border-cyan-500 ${
              ...
              <div>
                <div className="flex items-start">
                  ...
                  />
                  <label htmlFor="agreeToTerms" className={`${isRTL ? "mr-2" : "ml-2"} block text-sm text-gray-700`}>
